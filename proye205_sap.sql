...
-- Tiempo de generación: 02-01-2024 a las 11:50:29
...
(1, '444', 'Descripcion del sitio', NULL, NULL, 'mikeed1998@gmail.com', '', 'sap_admin@proyectoswozial.com', '+DRWa*uQB~al', 'mail.proyectoswozial.com', '465', NULL, '3333333333', '32323', '', 'https://www.facebook.com/', 'https://www.instagram.com/', NULL, NULL, NULL, NULL, NULL, NULL, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3735.26095032911!2d-100.3780338847383!3d20.57739830840845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d344c63af2b2af%3A0x8506d3bdeed8e510!2sAv.%20Luis%20Vega%20Monrroy%20901A%2C%20zona%20dos%20extendida%2C%20Plazas%20del%20Sol%201ra%20Secc%2C%2076099%20Santiago%20de%20Quer%C3%A9taro%2C%20Qro.!5e0!3m2!1ses-419!2smx!4v1635149990350!5m2!1ses-419!2smx\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\"></iframe>', 'Avenida Lapizlazuli 2074 int3. Residencial Victoria, Guadalajara, Jalisco, México.', NULL, '2023-12-29 21:10:45');
...
CREATE TABLE `productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Producto nuevo',
  `descripcion` text COLLATE utf8mb4_unicode_ci,
  `categoria` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `portada` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'producto_01.png',
  `pdf` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cantidad` int(11) DEFAULT NULL,
  `precio` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '$0.00',
...
CREATE TABLE `p_f_categoria_productos` (
  ...
  `aux` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `p_f_necesidades` (
  ...
  `necesidades` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `p_f_punto_ventas` (
  ...
  `estado` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mapa` text COLLATE utf8mb4_unicode_ci,
  `street_view` text COLLATE utf8mb4_unicode_ci,
  `aux` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `z_beneficios` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `beneficio` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icono` text COLLATE utf8mb4_unicode_ci,
  `color` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `z_blogs` (
  ...
  `portada` text COLLATE utf8mb4_unicode_ci,
...
(8, 'Acerca de este primer post', 'Entrada de este nuevo post', '20231229172123.png', '<p>dsffffffffffffff</p>', '#e5ff24', NULL, NULL, NULL, '2023-12-29 23:01:16', '2023-12-29 23:21:24'),
(9, '¿Acerca de las entradas de este blog?', 'El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido debajo para aquellos interesados. Las secciones 1.10.32 y 1.10.33 de \"de Finibus Bonorum et Malorum\" por Cicero son también reproducidas en su forma original exacta, acompañadas por versiones en Inglés de la traducción realizada en 1914 por H. Rackham.El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido debajo para aquellos interesados. Las secciones 1.10.32 y 1.10.33 de \"de Finibus Bonorum et Malorum\" por Cicero son también reproducidas en su forma original exacta, acompañadas por versiones en Inglés de la traducción realizada en 1914 por H. Rackham.El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido debajo para aquellos interesados. Las secciones 1.10.32 y 1.10.33 de \"de Finibus Bonorum et Malorum\" por Cicero son también reproducidas en su forma original exacta, acompañadas por versiones en Inglés de la traducción realizada en 1914 por H. Rackham.', '20231229172604.png', '<p>dsssssssssssssssssssssssssssssssssss<span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dssssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">sssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">ssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dssssssssss</span></p><p><span style=\"font-size: 1rem;\">sssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsss</span></p><p><span style=\"font-size: 1rem;\">ssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">sssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dssssssssssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">s</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">vcbc</span></p><p><span style=\"font-size: 1rem;\"><br></span></p><p><span style=\"font-size: 1rem;\"><br></span></p><p>dsssssssssssssssssssssssssssssssssss<span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">sssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">ssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">ssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">ssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">ssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dssssssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">sssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dssssssssssssssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">sss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">ssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssss</span></p><p><span style=\"font-size: 1rem;\">ssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\">dsssssssssssssssssssssssssssssssssss</span><span style=\"font-size: 1rem;\"><br></span></p>', '#7598ff', NULL, NULL, NULL, '2023-12-29 23:26:05', '2023-12-30 04:26:10');
...
CREATE TABLE `z_proyectos` (
  ...
  `titulo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci,
  `portado` text COLLATE utf8mb4_unicode_ci,
  `color` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, 7, 'Proyecto #1', 'Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...', '20231229160247.png', '#c6538a', '2023-12-21 23:53:58', '2023-12-29 22:02:48'),
...
(8, 16, 'NOMBRE DEL PROYECTO', 'lorem ipsum mamento mori, lorem ipsum mamento mori, lorem ipsum mamento mori,', '20231229220521.png', '#b4a0ca', '2023-12-30 04:05:21', '2023-12-30 04:05:21'),
(9, 16, 'Proyecto #1', 'lorem ipsum momemmto mortis, lorem ipsum momemmto mortis', '20231229220959.png', '#7868c4', '2023-12-30 04:10:00', '2023-12-30 04:10:00'),
(10, 9, 'Proyecto #1', 'lorem ipsum momemmto mortis,', '20231229221039.png', '#46c6c8', '2023-12-30 04:10:41', '2023-12-30 04:10:41'),
(11, 9, 'Proyecto #2', 'lorem ipsum momemmto mortis, lorem ipsum momemmto mortis, lorem ipsum momemmto mortis,', '20231229221121.png', '#f2ff38', '2023-12-30 04:11:21', '2023-12-30 04:11:21'),
(12, 9, 'Proyecto #3', 'lorem ipsum momemmto mortis, lorem ipsum momemmto mortis, lorem ipsum momemmto mortis, lorem ipsum momemmto mortis, lorem ipsum momemmto mortis,', '20231229221202.png', '#ff42dc', '2023-12-30 04:12:02', '2023-12-30 04:12:02');
...
CREATE TABLE `z_servicios` (
  ...
  `titulo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci,
  `descripcion2` text COLLATE utf8mb4_unicode_ci,
...
(16, 'PUENTES', 'Somos un medio de alta exposición y gran impacto con alto flujo vehícular. Tenemos carteleras en las principales avenidas del país logrando una visualización del medio forzosa. Contamos con mas de 3500 caras de exhibición, estructuras de calidad, iluminadas, con altura y posición, logrando el mayor impacto social.', 'Somos un medio de alta exposición y gran impacto con alto flujo vehícular. Tenemos carteleras en las principales avenidas del país logrando una visualización del medio forzosa. Contamos con mas de 3500 caras de exhibición, estructuras de calidad, iluminadas, con altura y posición, logrando el mayor impacto social.', 2, NULL, '20231229163754.png', '#ccaeec', '2023-12-29 22:28:13', '2023-12-29 22:37:54');
...
(10, '20240102174857.png', NULL, '2024-01-02 23:48:58', '2024-01-02 23:48:58');
...
CREATE TABLE `z_sucursals` (
  ...
  `sucursal` text COLLATE utf8mb4_unicode_ci,
  `coordX` text COLLATE utf8mb4_unicode_ci,
  `coordY` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(6, 9, 14, 575, '20231229175749.png', '2023-12-29 23:57:50', '2023-12-29 23:57:50'),
(7, 7, 9, 285, '20231229215948.png', '2023-12-30 03:59:48', '2023-12-30 03:59:48'),
(8, 8, 21, 1687, '20231229220013.png', '2023-12-30 04:00:14', '2023-12-30 04:00:14'),
...
(4, 'VACANTE', 'Somos un medio de alta exposición y gran impacto con alto flujo vehícular. Tenemos carteleras en las principales avenidas del país logrando una visualización del medio forzosa. Contamos con mas de 3500 caras de exhibición, estructuras de calidad, iluminadas, con altura y posición, logrando el mayor impacto social.', 2, '20231229160644.png', '#a977df', '2023-12-22 02:53:17', '2023-12-29 22:06:44'),
