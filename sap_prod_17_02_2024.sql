...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2024 a las 09:17:38
...
--
-- Estructura de tabla para la tabla `z_estados`
--

CREATE TABLE `z_estados` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ide` int(11) NOT NULL,
  `estado` varchar(255) DEFAULT NULL,
  `descripcion` text DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `z_estados`
--

INSERT INTO `z_estados` (`id`, `ide`, `estado`, `descripcion`, `aux`, `created_at`, `updated_at`) VALUES
(1, 1, 'Aguascalientes', '', '', NULL, NULL),
(2, 2, 'Baja California', '', '', NULL, NULL),
(3, 3, 'Baja California Sur', '', '', NULL, NULL),
(4, 4, 'Campeche', '', '', NULL, NULL),
(5, 7, 'Chiapas', '', '', NULL, NULL),
(6, 8, 'Chihuahua', '', '', NULL, NULL),
(7, 5, 'Coahuila de Zaragoza', '', '', NULL, NULL),
(8, 6, 'Colima', '', '', NULL, NULL),
(9, 10, 'Durango', '', '', NULL, NULL),
(10, 15, 'Estado de México', '', '', NULL, NULL),
(11, 11, 'Guanajuato', 'DESC GUANA', '', NULL, NULL),
(12, 12, 'Guerrero', '', '', NULL, NULL),
(13, 13, 'Hidalgo', '', '', NULL, NULL),
(14, 14, 'Jalisco', 'DESCRIPCION', '', NULL, NULL),
(15, 16, 'Michoacán de Ocampo', '', '', NULL, NULL),
(16, 17, 'Morelos', '', '', NULL, NULL),
(17, 18, 'Nayarit', '', '', NULL, NULL),
(18, 19, 'Nuevo León', '', '', NULL, NULL),
(19, 20, 'Oaxaca', '', '', NULL, NULL),
(20, 21, 'Puebla', '', '', NULL, NULL),
(21, 22, 'Querétaro', '', '', NULL, NULL),
(22, 23, 'Quintana Roo', '', '', NULL, NULL),
(23, 24, 'San Luis Potosí', '', '', NULL, NULL),
(24, 25, 'Sinaloa', '', '', NULL, NULL),
(25, 26, 'Sonora', '', '', NULL, NULL),
(26, 27, 'Tabasco', '', '', NULL, NULL),
(27, 28, 'Tamaulipas', '', '', NULL, NULL),
(28, 29, 'Tlaxcala', '', '', NULL, NULL),
(29, 30, 'Veracruz de Ignacio de la Llave', '', '', NULL, NULL),
(30, 31, 'Yucatán', '', '', NULL, NULL),
(31, 32, 'Zacatecas', '', '', NULL, NULL),
(32, 9, 'Ciudad de México', 'DESCRIPCION', '', NULL, NULL);
...
INSERT INTO `z_sucursals` (`id`, `estado`, `municipio`, `sucursal`, `estadodesc`, `coordX`, `coordY`, `created_at`, `updated_at`) VALUES
(5, 11, 345, 'Huimilpan 229, El Palote, 37130', 'DESC GUANA', '21.16872296760271', '-101.68050995254247', '2023-12-26 22:50:39', '2024-02-17 14:16:28'),
(6, 6, 72, 'Pedro Cervantez Vázquez 141, Sta Bárbara, 28017', '', '19.269488060266635', '-103.71514032040793', '2023-12-27 01:02:41', '2024-02-17 13:51:20'),
(7, 9, 285, 'Bahía de Chachalacas 36, Verónica Anzúres, Miguel Hidalgo, 11300', 'DESCRIPCION', '19.436499665563684', '-99.17467269023301', '2023-12-27 01:08:40', '2024-02-17 14:17:00'),
(8, 21, 1687, 'Juárez Ote. 813, entre Rio Bravo Norte y Rio Lerma Norte, Santiago Momoxpan, Rafael Ávila Camacho (Manantiales, 72757 Heroica Puebla de Zaragoza, Pue.', '', '19.079759342997107', '-98.26972580929856', '2023-12-27 01:11:32', '2024-02-17 13:51:20'),
(9, 14, 575, 'Av. Lapizlázuli 2074, 44560.', 'DESCRIPCION', '20.642154518163267', '-103.39664129383249', '2023-12-29 23:56:26', '2024-02-17 14:15:51'),
(10, 14, 656, 'Av. Mariano Otero 2375, Cd del Sol, 45050 Zapopan.', 'DESCRIPCION', '20.650229010894382', '-103.40188193045773', '2024-01-04 01:29:35', '2024-02-17 14:15:51');
...
--
-- Indices de la tabla `z_estados`
--
ALTER TABLE `z_estados`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `z_estados`
--
ALTER TABLE `z_estados`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
