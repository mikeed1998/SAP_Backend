                ...
                <div class="col-11 mx-auto">
                    <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-xxl-8 col-xl-8 col-lg-9 mx-auto text-center" style="margin-top: 10rem;">
                                        <button type="submit" disabled class="btn btn-outline rounded-pill py-3 w-100" style="background-color: #201E1F; color: #FFFFFF;">
                                            <div class="row">
                        ...
                        <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-9 mx-auto position-relative py-3">
                            <div class="row">
                                <div class="col pt-4">
                                    <input disabled type="text" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Nombre" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                                    <input disabled type="text" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Empresa" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                                    <input disabled type="number" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Whatsapp" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                                    <input disabled type="email" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Email" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                                    <input disabled type="text" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Asunto" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                                    <input disabled type="text" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Mensaje" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
