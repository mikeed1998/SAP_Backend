...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-11 position-relative text-center ">
        ...
        <div class="row">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-11 col-11 position-relative mx-auto text-center texto-bolsa">
            ...
            <div class="col imagen-vacantes position-relative" style="background-image: url('{{ asset('img/photos/imagenes_estaticas/'.$elements[2]->imagen) }}');">
                <div class="col-6 position-absolute top-50 start-50 translate-middle-x">
                    <form id="form_aux3" action="image_input_ejemplo" method="POST" class="file-upload px-auto col-7" enctype="multipart/form-data">
                        ...
                        <label class="col-12 py-5 m-0 px-2 d-flex justify-content-center align-items-center" for="img_aux3" style=" height: 100%; opacity: 100%; border-radius: 20px;">Seleccionar archivo</label>
                    </form>
                    <script>
    ...
    <div class="container-fluid py-5 bg-white">
        <div class="row">
            <div class="col-10 position-relative mx-auto beneficio-titulo">
    ...
    <section>
        <div class="container-fluid bg-white">
            <div class="row" data-aos="zoom-in">
                <div class="col py-5">
                    <div class="row">
                        <div class="col-9 position-relative mx-auto text-center">
                    ...
                    <div class="col-11 mx-auto">
                        <div class="row">
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-9 mx-auto position-relative">
                                <div class="col-12">
                                    <div class="row mt-5 mb-5">
                                        <div class="col-xxl-8 col-xl-8 col-lg-10 position-relative fs-5 mx-auto" style="line-height: 1.1;">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-xxl-8 col-xl-8 col-lg-10 mx-auto text-center">
                                            <button type="button" disabled id="fileButton" class="btn btn-outline rounded-pill py-3 w-100" style="background-color: #201E1F; color: #FFC000;">
                                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-8 col-xl-8 col-lg-10 mx-auto text-center">
                                            <button type="submit" disabled class="btn btn-outline rounded-pill py-3 w-100" style="background-color: #201E1F; color: #FFC000;">
                                                <div class="row">
                                                    <div class="col-8 text-end position-relative">
                                                        ENVÍA MENSAJE
                                                        <div class="col-4 text-end position-absolute top-50 start-100 translate-middle">
                            ...
                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-9 mx-auto position-relative py-3">
                                <div class="row">
                                    <div class="col pt-4">
                                        <input type="text" disabled class="form-control fs-3 bg-transparent rounded-0"  placeholder="Nombre" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col pt-4">
                                        <input type="email" disabled class="form-control fs-3 bg-transparent rounded-0"  placeholder="Email" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col pt-4">
                                        <input type="text" disabled class="form-control fs-3 bg-transparent rounded-0"  placeholder="Vacante" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col pt-4">
                                        <input type="text" disabled class="form-control fs-3 bg-transparent rounded-0"  placeholder="Mensaje" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                    </div>
                                </div>
