        ...
        <div class="container d-flex flex-wrap">
            ...
            <div class="col-4 p-3 " style="border-radius:26px;">
                <div class="card position-relative">
                    <img src="{{asset('img/photos/proyectos/'.$p->portado)}}" alt="" class="img-fluid">
                ...
                <div class="col-12 mt-3 d-flex flex-column" style="text-align: justify;">
                    @foreach ($servicios as $serva)
                        @if ($p->servicio == $serva->id)
                            <input type="text" class="form-control" value="Servicio: {{ $serva->titulo }}" disabled>
                            @break
                        @endif
                    @endforeach
                </div>
    ...
    <div  class="modal-content" style="border-radius: 16px;" >
        ...
        <div class="modal-body">
            ...
            <div class="col-12 mb-2">
                <label for="servicio" class="form-label">Servicio al que pertenece</label>
            ...
            <div class="col-12 mb-2">
                <input class="form-control" type="text" name="nom_proy" placeholder="Nombre del proyecto">
            </div>
            <div class="col-12 mb-2">
                <textarea class="form-control" name="desc_proy" id="" rows="6" placeholder="Descripción del proyecto"></textarea>
            </div>
