...
<section data-aos="fade-zoom-in"
        ...
        <div class="container-fluid py-5" style="background-color: #201E1F;">
            ...
            <div class="row">
                <div class="col text-center">
                    <small class="text-white">Hay que tratar de comprimir el video para evitar que ocupe demasiado espacio en la página y carge mas lento.</small>
                </div>
            </div>
            <div class="row py-5">
    ...
    <div class="container-fluid px-0">
        ...
        <div class="row">
            <div class="col text-center">
                <small class="text-white">Es recomendable evitar imágenes cuyo ancho y largo sean iguales, siguen funcionando pero al querer adaptarse en el diseño hacen un efecto de zoom, una medida recomenda por ejemplo, puede ser: 1200 X 800 pixeles.</small>
            </div>
        </div>
        <div class="row py-5">
        ...
        <div class="row bg-white">
            <div class="col text-center">
                <small class="text-dark">Se recomiendan imágenes mayores a 500 x 500 pixeles.</small>
            </div>
        </div>
