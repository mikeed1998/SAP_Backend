        ...
        <div class="row">
            <div class="col position-relative">
                ...
                <div class="col-12 d-flex justify-content-center align-items-center flex-column position-absolute start-0 top-0 bottom-0 cuadr z-3">
                    ...
                    <form action="{{ route('config.blog.delete', ['id' => $blog->id]) }}" method="POST" enctype="multipart/form-data" class="btn-do" id="boton-{{ $blog->id }}">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger text-white" style="font-size: 40px;">Eliminar</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        @else
            ...
            <div class="row">
                <div class="col position-relative">
                    ...
                    <div class="col-12 d-flex justify-content-center align-items-center flex-column position-absolute start-0 top-0 bottom-0 cuadr z-3">
                        <a href="{{ route('config.blog.edit', ['id' => $blog->id]) }}" class="btn btn-outline" style="font-size: 40px;">Editar Post</a>
                        <form action="{{ route('config.blog.delete', ['id' => $blog->id]) }}" method="POST" enctype="multipart/form-data" class="btn-do" id="botonn-{{ $blog->id }}">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger text-white" style="font-size: 40px;">Eliminar</button>
                    </form>
