    ...
    <div class="row">
        ...
        <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12 cont-pri">
            <div class="col-10 mx-auto">
                <div class="row">
                    <div class="col-12 titu-1" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                        {{ $elements[1]->texto }}
                    </div>
                    <div class="col-12 titu-2" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                        NOSOTROS
                    </div>
                </div>
                <div class="row">
                    <div class="col py-5 text-white titu-text" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                        {{ $elements[2]->texto }}
                    </div>
                </div>
            </div>
...
<div class="container-fluid" data-aos="fade-zoom-in"
    ...
    <div class="row">
        <div class="col nosotros-bg" style="background-image: url('{{ asset('img/images/nosotros/fondo.png') }}');">
            <div class="row">
                <div class="col text-center nosotros-1" style="font-family: 'Sansation Bold';">
                    {{ $elements[3]->texto }}
                </div>
            </div>
            <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-11 col-11 mx-auto text-center nosotros-2" style="font-family: 'Sansation Bold';">
                    {{ $elements[4]->texto }}
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-11 col-11 mx-auto text-center nosotros-3" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                    {{ $elements[5]->texto }}
                </div>
            </div>
        </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-9 col-sm-11 col-12 mx-auto py-5">
                    <div class="card border-0 px-4">
                        <div class="col position-relative border border-dark py-5">
                            ...
                            <div class="row">
                                <div class="col-9 mx-auto pt-3 titulo-card" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                    {{ $elements[6]->texto }}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-9 py-5 mx-auto texto-card" style="font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                    {{ $elements[7]->texto }}
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-9 col-sm-11 col-12 mx-auto py-5">
                    <div class="card border-0 px-4">
                        <div class="col position-relative border border-dark py-5">
                            ...
                            <div class="row">
                                <div class="col-9 py-5 mx-auto texto-card" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                    {{ $elements[9]->texto }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-9 mt-5 mx-auto">
                            <div class="row" data-aos="fade-right">
                                <div class="col py-2 rounded-pill titulo-nos" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                    {{ $elements[12]->texto }}
                                </div>
                            </div>
                            <div class="row" data-aos="fade-right">
                                <div class="col py-3 texto-nos" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                    {{ $elements[13]->texto }}
                                </div>
                            </div>
                        </div>
