                ...
                <div class="col-11 mx-auto">
                    <div class="row">
                        ...
                        <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-9 mx-auto position-relative py-3">
                            ...
                            <div class="row">
                                <div class="col pt-4">
                                    <input type="text" name="empresa" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Empresa" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                                    <input type="number" name="whatsapp" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Whatsapp" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                            ...
                            <div class="row">
                                <div class="col pt-4">
                                    <input type="text" name="asunto" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Asunto" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
