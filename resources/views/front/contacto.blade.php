                    ...
                    <div class="row">
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-9 mx-auto position-relative">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-8 fs-4 mx-auto" style="line-height: 1.1; margin-top: 3rem; text-decoration: underline; font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                        {{ $config->destinatario }}
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-9 mx-auto position-relative py-3">
                            ...
                            <div class="row">
                                <div class="col pt-4">
                                    <input required type="text" name="empresa" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Empresa" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                                    <input required type="number" name="whatsapp" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Whatsapp" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                            ...
                            <div class="row">
                                <div class="col pt-4">
                                    <input required type="text" name="asunto" class="form-control fs-3 bg-transparent rounded-0"  placeholder="Asunto" style="border-bottom: 2px solid black; border-top: 0; border-right: 0; border-left: 0; box-shadow: none;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col pt-4">
                ...
                <div class="col-11 mx-auto">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-12 col-12 mx-auto position-relative">
                            ...
                            <div class="row">
                                    <div class="col-8 fs-4 mx-auto" style="line-height: 1.1; margin-top: 4rem; text-decoration: underline; font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-family: 'Poppins', sans-serif; font-weight: bold;">
                                        TEL. {{ $config->telefono }}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-8 fs-4 mx-auto" style="line-height: 1.1; margin-top: 3rem; text-decoration: underline; font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-family: 'Poppins', sans-serif; font-weight: bold;">
                                        {{ $config->destinatario }}
                                    </div>
                                </div>
                                <div class="row">
