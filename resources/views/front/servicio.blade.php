            ...
            <div class="col px-0 portada-servicio position-realtive" style="background-image: url('{{ asset('img/photos/servicios/'.$servicio->imagen) }}');">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 py-5 position-absolute">
                    <div class="row">
                        <div class="col-9 mx-auto">
                            <div class="row">
                                <div class="col text-start display-1 fw-bolder text-white" style=" font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                    {{ $servicio->titulo }}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col py-1 fs-5 fw-normal text-white text-start" style="line-height: 1.1; font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 py-5 position-absolute top-100 end-0 cont-izq">
                    <div class="row">
                        <div class="col-9 mx-auto">
                            <div class="row">
                                <div class="col py-1 fs-5 fw-normal text-white text-start" style="line-height: 1.1; font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold; max-height: 6rem; overflow: auto;">
