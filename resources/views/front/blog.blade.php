                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-11 col-sm-11 col-11 mx-auto py-2 margen-tema">
                        <div class="row">
                            <div class="col-10 mx-auto titulo-blog">
                                ...
                                <div class="row">
                                    <div class="col-1"></div>
                                    <div class="col-11 py-4 texto-blog" style="font-family: 'Blinker', sans-serif; font-family: 'Montserrat', sans-serif; font-weight: bold;">
                                        {{ $blog->resumen }}
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xxl-7 col-xl-7 col-lg-9 col-md-9 col-sm-9 col-12 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-0 mx-sm-auto mx-auto text-center">
                                        <a href="{{ route('front.blog_detalle', ['id' => $blog->id]) }}" class="btn btn-outline py-3 fs-5 rounded-pill w-100 boton-blog" style="color: {{ $blog->color }}; border: 1px solid #BCBCBC;">
                                            <div class="row">
