                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="row">
                                <div class="col-3 py-3 mx-auto">
                                    <a href="https://api.whatsapp.com/send?text=http://192.168.0.101:8000/blog_detalle/{{ $blog->id }}" target="_blank" class="btn btn-outline">
                                ...
                                <div class="col-3 py-3 mx-auto">
                                    <a href="http://facebook.com/share.php?u=http://192.168.0.101:8000/blog_detalle/{{ $blog->id }}" target="_blank" class="btn btn-outline">
                                ...
                                <div class="col-3 py-3 mx-auto">
                                    <a href="https://www.instagram.com/share.php?u=http://192.168.0.101:8000/blog_detalle/{{ $blog->id }}" class="btn btn-outline">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="21" fill="#FFC000" viewBox="0 0 448 512">
                                            <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
