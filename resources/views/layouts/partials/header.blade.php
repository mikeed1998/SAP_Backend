                ...
                <div class="col px-5 mx-auto py-3 position-relative" style="flex-grow: 1;">
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-3 col-sm-9 col-9 mx-auto position-relative">
                            <div class="row">
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-9 col-9 mx-auto mt-4 text-center">
                                            ...
                                            <div class="col-xxl-5 col-xl-7 col-lg-7 col-md-7 col-sm-9 col-9 py-3">
                                                <div class="row">
                                                    <div class="col-xxl-4 col-xl-4 col-lg-3 col-md-3 col-sm-3 col-3 mx-xxl-0 mx-xl-0 mx-lg-auto mx-md-auto mx-sm-0 mx-0">
                                                        <div class="row">
                                                            <a href="http://wa.me/{{ $config->whatsapp }}" class="col-10 mx-auto d-flex align-items-center justify-content-center border border-white text-center bg-white rounded-circle header-btn">
                                                    ...
                                                    <div class="col-xxl-4 col-xl-4 col-lg-3 col-md-3 col-sm-3 col-3 mx-xxl-0 mx-xl-0 mx-lg-auto mx-md-auto mx-sm-0 mx-0">
                                                        <div class="row">
                                                            <a href="{{ $config->facebook }}" class="col-10 mx-auto d-flex align-items-center justify-content-center border border-white text-center bg-white rounded-circle">
                                                    ...
                                                    <div class="col-xxl-4 col-xl-4 col-lg-3 col-md-3 col-sm-3 col-3 mx-xxl-0 mx-xl-0 mx-lg-auto mx-md-auto mx-sm-0 mx-0">
                                                        <div class="row">
                                                            <a href="{{ $config->instagram }}" class="col-10 mx-auto d-flex align-items-center justify-content-center border border-white text-center bg-white rounded-circle">
