				...
				<div class="text-center">
					...
					<li>
						...
						<ul class="collapsible collapsible-accordion">
							...
							<li class="p-2">
								<a  href="{{ route('config.seccion.show', ['slug' => 'blog']) }}" class="collapsible-header waves-effect {{ (request()->is('admin/config/secciones/blog')) ? 'active' : '' }}" style="border-radius: 16px; text-decoration: none; "><i class="fas fa-archway"></i>Blog</a>
							</li>
							<li class="p-2">
								<a  href="{{ route('config.seccion.show', ['slug' => 'sucursals']) }}" class="collapsible-header waves-effect {{ (request()->is('admin/config/secciones/sucursals')) ? 'active' : '' }}" style="border-radius: 16px; text-decoration: none; "><i class="fa-solid fa-location-dot"></i>&nbsp;&nbsp;Sucursales</a>
							</li>
							<li class="p-2">
								<a  href="{{ route('config.seccion.show', ['slug' => 'work']) }}" class="collapsible-header waves-effect {{ (request()->is('admin/config/secciones/work')) ? 'active' : '' }}" style="border-radius: 16px; text-decoration: none; "><i class="fa-solid fa-briefcase"></i>&nbsp;&nbsp;Bolsa de trabajo</a>
							</li>
