...
<script src="https://cdn.jsdelivr.net/npm/uikit@3.17.11/dist/js/uikit-icons.min.js"></script>
        ...
        font-style: normal;
        font-weight: normal;
        src: url('/fonts/Sansation-Bold/Sansation_Bold.ttf') format('ttf');
    }
		</style>

		<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Blinker:wght@300&family=Montserrat&family=Poppins:wght@100&display=swap" rel="stylesheet">

		@yield('jsLibExtras')
		@yield('cssExtras')
		@yield('styleExtras')
	</head>
	<body style="background-color: #201E1F; font-family: 'Sansation Bold';">
    ...
    $(document).ready(function () {
        // Agregar evento de clic al enlace "Servicios"
        $("#toggleServicios").click(function () {
            // Mostrar u ocultar el contenido dependiendo de su estado actual
            $("#serviciosContent").toggle();
        });
    });
</script>
